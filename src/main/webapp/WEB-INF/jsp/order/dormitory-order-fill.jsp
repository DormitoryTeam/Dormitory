	...
	<form action="/dormitory/order/dormitory-order-place.html" method="POST">
		<table>
			...
			<tr id="trOther" style="display: none;">
				<td>Email:</td>
				<td><input type="text" id="otheremail" name="otheremail" value="" /></td>
			...
			<tr>
				<td>Name:</td>
				<td><input type="text" class="otheruser" name="othername" id="othername" value="${user['name']}" />
			...
			<tr>
				<td>Address</td>
				<td colspan="3"><input type="text" class="otheruser" name="otheraddress" id="otheraddress" value="${user['address']}" /></td>
			</tr>
			<tr>
